...
ruleTester.run('jsx-no-hardcoded-content', rule, {
  valid: [
    ...
    {
      code: `
        import * as DesignSystem from '@beefchimi/design-system';
        <DesignSystem.MyComponent>Content</DesignSystem.MyComponent>
      `,
      filename: fixtureFile('basic-app/app/sections/MySection/MySection.js'),
      options: [
        {
          modules: {
            '@beefchimi/design-system': {
              MyComponent: allowStrings,
            },
          },
        },
    ...
    {
      code: `
        import {MyComponent} from '@beefchimi/design-system';
  ...
  invalid: [
    ...
    },
    {
      ...
      errors: errorsFor('DesignSystem.MyComponent', 'children'),
    },
    {
      code: `
        import * as DesignSystem from '@beefchimi/design-system';
        <DesignSystem.MyComponent>{42}</DesignSystem.MyComponent>
      `,
      filename: fixtureFile('basic-app/app/sections/MySection/MySection.js'),
      options: [
        {
